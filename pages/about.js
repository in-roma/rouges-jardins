				...
				<section className={styles.containerAbout}>
					...
					<article className={styles.contentAbout}>
						...
						<p className={styles.textAbout}>
							...
							reprend ses études sur le tard, d&#39;abord pharma,
							puis internat de biologie. Il ouvre en 1989 un
							laboratoire d&#39;analyses médicales dans la commune
						...
						<p className={styles.textAbout}>
							...
							s&#39;efforce tout au long des ces années de faire
							vivre un laboratoire à l&#39;excellence médicale. Au
						...
						<p className={styles.textAbout}>
							...
							l&#39;homme et la nature, d&#39;abord dans les 1990
							sous la forme d&#39;un fanzine informel envoyé par
							courrier à ses proches, plus tard avec sa première
							publication en 2004&nbsp;
							<em>NZO ou les grimoires d&#39;un vieux singe</em>.
							Elle sera suivie d&#39;autres livres dont&nbsp;
						...
						<p className={styles.textAbout}>
							Aujourd&#39;hui Guy est un jeune retraité, continue
